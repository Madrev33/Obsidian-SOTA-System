...
import { Priority, TaskRegularExpressions, type TaskComponents } from './TaskModels' // Adicionado
...
export class DataviewTaskSerializer extends DefaultTaskSerializer {
    ...
    public override extractComponents(line: string): TaskComponents | null {
        // Para o Dataview, usamos a mesma lógica de extração do Default.
