...
import { Priority, TaskRegularExpressions, type TaskComponents } from './TaskModels' // Adicionado TaskComponents
...
export class DefaultTaskSerializer implements TaskDeserializer {
    ...
    public extractComponents(line: string): TaskComponents | null {
    ...
    public deserialize(line: string): TaskDetails {
        ...
        // SOTA FIX: We parse the pomodoro counter to extract its data, but we NO LONGER
        // remove it from the 'line' string. The full description is preserved.
        ...
        if (pomodorosMatch !== null) {
            ...
            // The line that removed the counter has been deleted.
        }
        ...
        do {
            ...
            // SOTA FIX: The pomodoro parsing logic has been moved out and before this loop.
