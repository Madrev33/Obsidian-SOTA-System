...
grupo_muscular_id: "%%ID_GRUPO_MUSCULAR%%"
tags:
...
> *Lista de todos os exercícios registrados no Manual para este grupo muscular.*
```dataview
LIST
...
> *Principais indicadores de performance para este grupo muscular ao longo do tempo.*
```dataviewjs
dv.view("99 - BACKEND/Scripts/Views/Exercicios/renderKPIsGrupoMuscular.js", { 
