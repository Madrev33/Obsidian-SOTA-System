...
> - **Plataforma:** `INPUT[suggester(optionQuery(#serie_plataforma), allowOther):plataforma]`
> - **Categoria:** `INPUT[suggester(optionQuery(#serie_categoria), allowOther):categoria]`
> - **Idioma:** `INPUT[suggester(optionQuery(#serie_idioma), allowOther):idioma]`
> - **Diretor(a):** `INPUT[suggester(optionQuery(#serie_diretor), allowOther):diretor]`
...
actions:
  - type: inlineJS
    code: |
      ...
      const macroName = "Adicionar Temporada a Série";
...
```dataviewjs
await dv.view("99 - BACKEND/Scripts/Views/Serie/renderGuiaTemporada")
```

---

## 💬 Avaliação & Opinião Geral do Série
