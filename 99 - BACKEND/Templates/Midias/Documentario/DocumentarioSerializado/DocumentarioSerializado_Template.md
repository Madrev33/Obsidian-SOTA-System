---
tipo: documentario_serializado_hub
sota_uid: "%%SOTA_UID%%"
id_midia: "%%ID_MIDIA%%"
...
tags:
  - midia
  - midia/documentario_serializado_hub
---

> [!summary] Detalhes do Documentário
...
> - **Plataforma:** `INPUT[suggester(optionQuery(#documentario_plataforma), allowOther):plataforma]`
> - **Diretor(a):** `INPUT[suggester(optionQuery(#documentario_diretor), allowOther):diretor]`
> - **Categoria:** `INPUT[suggester(optionQuery(#documentario_categoria), allowOther):categoria]`
> - **Idioma:** `INPUT[suggester(optionQuery(#documentario_idioma), allowOther):idioma]`
...
actions:
  - type: inlineJS
    code: |
      ...
      const macroName = "Adicionar Temporada a Documentário Serializado";
...
```dataviewjs
await dv.view("99 - BACKEND/Scripts/Views/Documentario/renderGuiaTemporada")
```

---

## 💬 Avaliação & Opinião Geral do Documentário
