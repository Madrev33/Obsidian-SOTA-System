---
tipo: documentario_temporada_hub
hub_uid: "%%HUB_UID%%"
...
rating: 0
tags:
  - documentario_temporada_hub
---

# HUB - Temporada %%NUMERO_TEMPORADA%%: %%NOME_DOCUMENTARIO%%
...
actions:
  - type: inlineJS
    code: |
      ...
      const macroName = "Adicionar Episódios a temporada (Documentário Serializado)";
...
const pages = dv.pages(`"${pastaDoModulo}"`)
    ...
    .where(p => p.tipo === 'documentario_episodio' && p.hub_uid === hubModulo.hub_uid)
