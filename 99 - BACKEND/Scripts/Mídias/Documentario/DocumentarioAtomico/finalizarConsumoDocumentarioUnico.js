// SOTA - Script para Finalizar o Consumo de um Documentário Único v1.0
...
module.exports = async (params) => {
    ...
    class ConfirmarFinalizacaoModal extends Modal {
        ...
        onOpen() {
            this.contentEl.createEl("h2", { text: "Finalizar Consumo do Documentário?" });
    ...
    try {
        ...
        if (cicloObj && cicloObj.status === 'concluido') {
            new Notice(`ℹ️ O Ciclo ${cicloAtualNum} deste documentário já está finalizado.`);
            return;
        }
        ...
        new Notice("🚀 Finalizando ciclo de leitura do documentário...");
        ...
        new Notice(`✅ Consumo do documentário finalizado!`);

    } catch (e) {
        new Notice("❌ ERRO crítico ao finalizar consumo. Verifique o console.");
        console.error("Erro em finalizarConsumoDocumentárioAtomico.js:", e);
    }
};