// SOTA - Script para Finalizar um Ciclo de Documentário
...
module.exports = async (params) => {
    ...
    const sotaLog = (step, data) => console.log(`[SOTA Finalizar Ciclo Documentário] - ${step}`, data !== undefined ? data : "");
    ...
    new Notice("🚀 Finalizando ciclo da Documentário...");
