// SOTA - Script para Finalizar o Consumo de uma Documentário (Pausa Longa)
...
module.exports = async (params) => {
    ...
    class ConfirmarFinalizacaoModal extends Modal {
        ...
        onOpen() {
            ...
            this.contentEl.createEl("p", { text: "Esta opção mantém o ciclo atual aberto. Se novas Temporadas forem lançadas no futuro, você poderá simplesmente reativar o Documentário e continuar de onde parou." });               
    ...
    if (erro) {
      ...
      new Notice(`✅ Consumo do Ciclo ${cicloAfetado} finalizado! A Documentário está em 'pausa longa'.`);
    } else {
