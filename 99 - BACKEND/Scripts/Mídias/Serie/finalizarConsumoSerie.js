// SOTA - Script para Finalizar o Consumo de uma Série (Pausa Longa)
...
module.exports = async (params) => {
    ...
    class ConfirmarFinalizacaoModal extends Modal {
        ...
        onOpen() {
            this.contentEl.createEl("h2", { text: "Finalizar Consumo da Série?" });
            this.contentEl.createEl("p", { text: "Esta ação marca a Série como 'concluído', indicando que você terminou de assistir todo o conteúdo disponível no momento." });
            this.contentEl.createEl("p", { text: "Se novas Temporadas forem lançados no futuro, você poderá simplesmente reativar a Série e continuar de onde parou." });               
    ...
    if (erro) {
      ...
      new Notice(`✅ Consumo do Ciclo ${cicloAfetado} finalizado! A Série está em 'pausa longa'.`);
    } else {
