// SOTA - iniciarNovoCicloLeituraDocumentacaoPaginado.js v1.0
// Cria a estrutura de um novo ciclo de leitura para uma Documentacao Paginada.
...
module.exports = async (params) => {
    ...
    class ConfirmarNovoCicloModal extends Modal {
        ...
        onOpen() {
            ...
            this.contentEl.createEl("p", { text: "Esta ação é recomendada para quando você deseja reler a documentação do zero. Uma nova estrutura de pastas será criada para o próximo ciclo." });
    ...
    try {
        ...
        if (await app.vault.adapter.exists(pastaCicloNovo)) {
            ...
            if (totalSecoes > 0) {
                const templateSecaoPath = `99 - BACKEND/Templates/Midias/Documentacao/Documentacao_Paginado_Secao_Template.md`;
                ...
                for (let i = 1; i <= totalSecoes; i++) {
                    ...
                    try {
                        const templatePath = "99 - BACKEND/Templates/Midias/Documentacao/Excalidraw_Template_Vazio_Documentacao_Paginado.md";
        ...
        console.error("Erro no script iniciarNovoCicloLeituraDocumentacaoPaginado:", error);
