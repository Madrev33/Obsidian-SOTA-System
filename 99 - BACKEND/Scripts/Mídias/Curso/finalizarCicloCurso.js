// SOTA - Script para Finalizar um Ciclo de Estudo de Curso
...
module.exports = async (params) => {
    ...
    const sotaLog = (step, data) => console.log(`[SOTA Finalizar Ciclo Curso] - ${step}`, data !== undefined ? data : "");
    ...
    new Notice("🚀 Finalizando ciclo de estudo...");
    ...
    if (erro) {
      ...
      new Notice(`✅ Estudo do Ciclo ${cicloFinalizado} finalizado com sucesso!`);
