// SOTA - Script para Finalizar um Ciclo de Podcast
...
module.exports = async (params) => {
    ...
    const sotaLog = (step, data) => console.log(`[SOTA Finalizar Ciclo Podcast] - ${step}`, data !== undefined ? data : "");
    ...
    new Notice("🚀 Finalizando ciclo do Podcast...");
