// SOTA - Script para Finalizar o Consumo de uma Podcast (Pausa Longa)
...
module.exports = async (params) => {
    ...
    class ConfirmarFinalizacaoModal extends Modal {
        ...
        onOpen() {
            ...
            this.contentEl.createEl("p", { text: "Esta opção mantém o ciclo atual aberto. Se novas Temporadas forem lançados no futuro, você poderá simplesmente reativar o Podcast e continuar de onde parou." });               
    ...
    if (erro) {
      ...
      new Notice(`✅ Consumo do Ciclo ${cicloAfetado} finalizado! A Podcast está em 'pausa longa'.`);
    } else {
