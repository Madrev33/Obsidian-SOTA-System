// SOTA - Script para Finalizar o Consumo de um Podcast Único v1.0
...
module.exports = async (params) => {
    ...
    class ConfirmarFinalizacaoModal extends Modal {
        ...
        onOpen() {
            this.contentEl.createEl("h2", { text: "Finalizar Consumo do Podcast?" });
    ...
    try {
        ...
        if (cicloObj && cicloObj.status === 'concluido') {
            new Notice(`ℹ️ O Ciclo ${cicloAtualNum} deste Podcast já está finalizado.`);
            return;
        }
        ...
        new Notice("🚀 Finalizando ciclo atual do Podcast...");
        ...
        new Notice(`✅ Consumo do Podcast finalizado!`);

    } catch (e) {
        new Notice("❌ ERRO crítico ao finalizar consumo. Verifique o console.");
        console.error("Erro em finalizarConsumoPodcastAtomico.js:", e);
    }
};