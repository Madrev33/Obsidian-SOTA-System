// SOTA - Script para Finalizar um Ciclo de Leitura de Artigo Paginado v1.0
...
module.exports = async (params) => {
    ...
    // --- CLASSE DO MODAL (ADAPTADA PARA ARTIGO) ---
    class ConfirmarFinalizacaoModal extends Modal {
        ...
        onOpen() {
            this.contentEl.createEl("h2", { text: "Finalizar Ciclo de Leitura do Artigo?" });
    ...
    if (!(activeFile instanceof TFile)) { new Notice("❌ ERRO: Não foi possível encontrar o arquivo HUB do Artigo."); return; }
    ...
    try {
        ...
        console.error("Erro de validação em finalizarCicloLeituraArtigoPaginado.js:", e);
        return;
    }
    // --- FIM DA VALIDAÇÃO ---
