// Componente SOTA: renderCronogramaCurso.js (v4.0 - Hierarquia de Finalização Invertida)
// Prioriza o último 'conclusao_consumo' como o fim do ciclo. Arquivamento é fallback.
async function main() {
    ...
    const hubArray = dv.pages().where(p => p.id_midia === idMidia && p.tipo === "curso_hub");
